    ...
    <header className={`fixed top-0 left-0 right-0 z-50 transition-colors duration-300 ${
      ...
      <nav className="relative z-50 mx-auto max-w-7xl px-6 lg:px-10 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <a href="#register" className="hidden sm:inline-block rounded-full bg-signal text-ink text-sm font-semibold px-5 py-2.5 hover:bg-signal-glow transition-colors">
            Register
          </a>
